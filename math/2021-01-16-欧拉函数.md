...
$\varphi(10) = 10(1 - \frac{1}{2})(1 - \frac{1}{5} ) = 4$, 包含$(1、3、7、 9)$
...
ll euler_drop_pow(ll a,char b[],ll c) {  
    ll num = get_eular(c);  //c的欧拉函数值
    ll pows = 0;  //存储降了之后的幂
