...
> 参考
>
> - [cmake使用详细教程(日常使用这一篇就足够)](https://blog.csdn.net/iuu77/article/details/129229361)

## 概念

`cmake` 是一个跨平台`c/c++`构建系统生成工具, 通过解析`CMakeLists.txt`(`cmake`配置文件), 自动生成适用于不同平台的构建文件(如 `Makefile`、`Ninja` 文件、`Visual Studio` 工程文件等)
