...
```c
// main.cpp
#include "hello_1/hello_1.hpp"
#include "hello_2/hello_2.hpp"
...
- 示例, 生成可执行文件, 链接lib/libtest_api.so
...
创建交叉编译工具链文件, 设置编译环境, 通过`-DCMAKE_TOOLCHAIN_FILE`参数指定路径
